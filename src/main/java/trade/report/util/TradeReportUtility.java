...
public final class TradeReportUtility {
    ...
    /**
     * This method calculates the incoming or outgoing amount settled in USD on different dates
     *
     * @param tradeInstructions - a list of trade instructions
     * @param instructionType - type of instruction (incoming or outgoing)
     * @return
     */
    public static Map<LocalDate, Double> calculateUSDSettlements(final List<TradeInstruction> tradeInstructions, final InstructionType instructionType) {
    ...
    /**
     * This method calculates the rankings of the entities based on incoming or outgoing amounts.
     *
     * @param tradeInstructions - a list of trade instructions
     * @param instructionType - type of instruction (incoming or outgoing)
     * @return
     */
    public static List<Map.Entry<String, Double>> calculateRankings(final List<TradeInstruction> tradeInstructions, final InstructionType instructionType) {
        Objects.requireNonNull(tradeInstructions, "Trade instructions should not be null.");
        return tradeInstructions.stream()
                .filter(trade -> instructionType.equals(trade.getInstructionType()))
